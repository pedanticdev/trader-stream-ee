...
public class GCStats {
  ...
  public long getLastPauseDuration() {
    return lastPauseDuration;
  }

  public void setLastPauseDuration(long lastPauseDuration) {
    this.lastPauseDuration = lastPauseDuration;
  }

  public List<Long> getRecentPauses() {
    return recentPauses;
  }

  public void setRecentPauses(List<Long> recentPauses) {
    this.recentPauses = recentPauses;
  }

  public PausePercentiles getPercentiles() {
    return percentiles;
  }

  public void setPercentiles(PausePercentiles percentiles) {
