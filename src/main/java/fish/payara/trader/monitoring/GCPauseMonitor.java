...
public class GCPauseMonitor implements NotificationListener {
    ...
    public static class GCPauseStats {
        ...
        public GCPauseStats(long totalPauseCount, long totalPauseTimeMs, double avgPauseMs, long p50Ms, long p95Ms, long p99Ms, long p999Ms, long maxMs,
                        long violationsOver10ms, long violationsOver50ms, long violationsOver100ms, int sampleSize) {
