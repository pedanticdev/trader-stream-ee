...
public class SLAMonitorService {
    ...
    public SLAStats getStats() {
        ...
        return new SLAStats(total, violationsOver10ms.get(), violationsOver50ms.get(), violationsOver100ms.get(),
                        total > 0 ? (double) violationsOver10ms.get() / total * 100 : 0, violationsByMinute.values().stream().mapToLong(Long::longValue).sum());
    }
