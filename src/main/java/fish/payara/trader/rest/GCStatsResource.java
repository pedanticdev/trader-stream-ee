...
public class GCStatsResource {
  ...
  @Inject private GCStatsService gcStatsService;

  @Inject private MemoryPressureService memoryPressureService;

  @Inject private MarketDataPublisher publisher;

  @Inject private fish.payara.trader.monitoring.SLAMonitorService slaMonitor;

  @Inject private fish.payara.trader.monitoring.GCPauseMonitor gcPauseMonitor;
