 ...
 *
 * Clients connect to ws://host:port/context/market-data
 * and receive real-time JSON market data updates.
 */
    ...
    public void onOpen(Session session) {
        ...
        try {
            String welcomeJson = String.format(
                "{\"type\":\"info\",\"message\":\"Connected to TradeStreamEE market data feed\",\"mode\":\"%s\"}",
                ingestionMode
            );
