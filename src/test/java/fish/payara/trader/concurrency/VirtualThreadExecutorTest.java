...
class VirtualThreadExecutorTest {
  ...
  void shouldBeAnInterface() {
    // Assert
    assertTrue(
        VirtualThreadExecutor.class.isInterface(), "VirtualThreadExecutor should be an interface");
  }
  ...
  void shouldBeInCorrectPackage() {
    ...
    assertEquals(
        ...
        VirtualThreadExecutor.class.getPackage().getName(),
  ...
  void shouldHaveCorrectSimpleName() {
    ...
    assertEquals(
        ...
        VirtualThreadExecutor.class.getSimpleName(),
  ...
  void shouldHaveNoDeclaredConstructors() {
    ...
    java.lang.reflect.Constructor<?>[] constructors =
        VirtualThreadExecutor.class.getDeclaredConstructors();
  ...
  void shouldHaveNoDeclaredAnnotationsExceptStandardOnes() {
    ...
    java.lang.annotation.Annotation[] annotations =
        VirtualThreadExecutor.class.getDeclaredAnnotations();
  ...
  void shouldBeSuitableForDependencyInjection() {
    ...
    Retention retention = VirtualThreadExecutor.class.getAnnotation(Retention.class);
    assertEquals(
        RetentionPolicy.RUNTIME, retention.value(), "Should be retained at runtime for injection");
  }
  ...
  void shouldHaveDescriptiveDocumentation() {
    ...
    assertEquals(
        "fish.payara.trader.concurrency", pkg.getName(), "Should be in meaningful package");
