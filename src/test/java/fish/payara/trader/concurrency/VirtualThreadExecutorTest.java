...
class VirtualThreadExecutorTest {
    ...
    void shouldHaveCorrectTargetTypes() {
        ...
        assertTrue(containsTarget(elementTypes, ElementType.METHOD),
            "Should target METHOD");
        assertTrue(containsTarget(elementTypes, ElementType.FIELD),
            "Should target FIELD");
        assertTrue(containsTarget(elementTypes, ElementType.PARAMETER),
            "Should target PARAMETER");
        assertTrue(containsTarget(elementTypes, ElementType.TYPE),
            "Should target TYPE");
    }
    ...
    void shouldHaveCorrectRetentionPolicy() {
        ...
        assertEquals(RetentionPolicy.RUNTIME, retention.value(),
            "Should have RUNTIME retention policy");
    }
    ...
    void shouldBeAnInterface() {
        // Assert
        assertTrue(VirtualThreadExecutor.class.isInterface(),
            "VirtualThreadExecutor should be an interface");
    }
    ...
    void shouldHaveCorrectSimpleName() {
        // Assert
        assertEquals("VirtualThreadExecutor", VirtualThreadExecutor.class.getSimpleName(),
