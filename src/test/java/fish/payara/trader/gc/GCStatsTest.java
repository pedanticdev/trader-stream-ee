...
class GCStatsTest {
  ...
  class CollectionStatisticsTests {
    ...
    void shouldSetAndGetCollectionCountCorrectly() {
      ...
      assertEquals(
          ...
          "Collection count should be set and retrieved correctly");
    }
    ...
    void shouldHandleNegativeCollectionCount() {
      ...
      assertEquals(
          negativeCount, stats.getCollectionCount(), "Negative collection count should be handled");
    }
    ...
    void shouldHandleVeryLargeCollectionCount() {
      ...
      assertEquals(
          largeCount, stats.getCollectionCount(), "Very large collection count should be handled");
    }
    ...
    void shouldSetAndGetCollectionTimeCorrectly() {
      ...
      assertEquals(
          ...
          "Collection time should be set and retrieved correctly");
    }
    ...
    void shouldHandleNegativeCollectionTime() {
      ...
      assertEquals(
          negativeTime, stats.getCollectionTime(), "Negative collection time should be handled");
    }
  }
  ...
  class PauseDurationTests {
    ...
    void shouldSetAndGetLastPauseDurationCorrectly() {
      ...
      assertEquals(
          pauseDuration,
          stats.getLastPauseDuration(),
          "Last pause duration should be set and retrieved correctly");
    }
    ...
    void shouldHandleVeryLongPauseDuration() {
      ...
      assertEquals(
          longPause, stats.getLastPauseDuration(), "Very long pause duration should be handled");
    }
    ...
    void shouldHandleMicrosecondLevelPauseDuration() {
      ...
      assertEquals(
          microPause,
          stats.getLastPauseDuration(),
          "Microsecond-level pause duration should be handled");
    }
  }
  ...
  class RecentPausesTests {
    ...
    void shouldSetAndGetRecentPausesListCorrectly() {
      ...
      assertEquals(
          pauses,
          stats.getRecentPauses(),
          "Recent pauses list should be set and retrieved correctly");
    }
    ...
    void shouldHandleEmptyRecentPausesList() {
      ...
      assertEquals(
          emptyList, stats.getRecentPauses(), "Empty recent pauses list should be handled");
    }
    ...
    void shouldHandleNullRecentPausesList() {
      ...
      assertDoesNotThrow(
          () -> stats.setRecentPauses(null), "Setting null recent pauses should not throw");
  ...
  class PercentilesTests {
    ...
    void shouldSetAndGetPercentilesCorrectly() {
      GCStats stats = new GCStats();
      GCStats.PausePercentiles percentiles =
          new GCStats.PausePercentiles(10L, 25L, 50L, 100L, 200L);

      stats.setPercentiles(percentiles);
      assertEquals(
          percentiles, stats.getPercentiles(), "Percentiles should be set and retrieved correctly");
    }
    ...
    void shouldHandleNullPercentiles() {
      ...
      assertDoesNotThrow(
          () -> stats.setPercentiles(null), "Setting null percentiles should not throw");
  ...
  class MemoryStatisticsTests {
    ...
    void shouldSetAndGetTotalMemoryCorrectly() {
      ...
      assertEquals(
          ...
          "Total memory should be set and retrieved correctly");
    }
    ...
    void shouldSetAndGetUsedMemoryCorrectly() {
      ...
      assertEquals(
          usedMemory, stats.getUsedMemory(), "Used memory should be set and retrieved correctly");
    }
    ...
    void shouldSetAndGetFreeMemoryCorrectly() {
      ...
      assertEquals(
          freeMemory, stats.getFreeMemory(), "Free memory should be set and retrieved correctly");
    }
    ...
    void shouldMaintainMemoryRelationshipTotalGTEUsed() {
      ...
      assertTrue(
          stats.getTotalMemory() >= stats.getUsedMemory(),
          "Total memory should be greater than or equal to used memory");
    }
    ...
    void shouldMaintainMemoryRelationshipTotalGTFree() {
      ...
      assertTrue(
          stats.getTotalMemory() >= stats.getFreeMemory(),
          "Total memory should be greater than or equal to free memory");
    }
    ...
    void shouldMaintainMemoryRelationshipTotalGEUsedPlusFree() {
      ...
      assertTrue(
          stats.getTotalMemory() >= stats.getUsedMemory() + stats.getFreeMemory(),
