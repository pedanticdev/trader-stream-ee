...
class AllocationModeTest {
    ...
    class AllocationPropertiesTests {
        ...
        void shouldHaveCorrectAllocationPerIterationValues(AllocationMode mode) {
            ...
            assertEquals(expected, mode.getAllocationsPerIteration(),
        ...
        void shouldHaveCorrectBytesPerAllocationValues(AllocationMode mode) {
            ...
            assertEquals(expected, mode.getBytesPerAllocation(),
    ...
    class BytesPerSecondCalculationTests {
        ...
        void shouldCalculateBytesPerSecondCorrectlyForLowMode() {
            ...
            assertEquals(1_024_000L, AllocationMode.LOW.getBytesPerSecond(),
                "LOW mode should allocate 1 MB/sec");
        }
        ...
        void shouldCalculateBytesPerSecondCorrectlyForMediumMode() {
            ...
            assertEquals(10_240_000L, AllocationMode.MEDIUM.getBytesPerSecond(),
        ...
        void shouldCalculateBytesPerSecondCorrectlyForHighMode() {
            ...
            assertEquals(512_000_000L, AllocationMode.HIGH.getBytesPerSecond(),
        ...
        void shouldCalculateBytesPerSecondCorrectlyForExtremeMode() {
            ...
            assertEquals(2_048_000_000L, AllocationMode.EXTREME.getBytesPerSecond(),
    ...
    class ProgressiveIntensityTests {
        ...
        void shouldHaveProgressivelyIncreasingAllocationRates() {
            ...
            for (AllocationMode mode : AllocationMode.values()) {
                ...
                assertTrue(currentRate >= previousRate,
                    String.format("%s (%d bytes/sec) should be >= previous rate (%d)",
        ...
        void shouldHaveMonotonicAllocationPerIterationProgression() {
            ...
            for (AllocationMode mode : AllocationMode.values()) {
                ...
                assertTrue(currentAllocations >= previousAllocations,
                    String.format("%s (%d allocations) should be >= previous (%d)",
        ...
        void shouldHaveSignificantGapsBetweenModes() {
            ...
            assertTrue(AllocationMode.LOW.getBytesPerSecond() > AllocationMode.OFF.getBytesPerSecond(),
                "LOW should be significantly higher than OFF");

            assertTrue(AllocationMode.MEDIUM.getBytesPerSecond() > AllocationMode.LOW.getBytesPerSecond() * 5,
                "MEDIUM should be at least 5x higher than LOW");

            assertTrue(AllocationMode.HIGH.getBytesPerSecond() > AllocationMode.MEDIUM.getBytesPerSecond() * 40,
                "HIGH should be at least 40x higher than MEDIUM");

            assertTrue(AllocationMode.EXTREME.getBytesPerSecond() > AllocationMode.HIGH.getBytesPerSecond() * 2,
    ...
    class DescriptionContentTests {
        ...
        void descriptionsShouldContainPressureLevelIndicators() {
            assertTrue(AllocationMode.LOW.getDescription().contains("Light"),
                "LOW description should contain 'Light'");

            assertTrue(AllocationMode.MEDIUM.getDescription().contains("Moderate"),
                "MEDIUM description should contain 'Moderate'");

            assertTrue(AllocationMode.HIGH.getDescription().contains("Heavy"),
                "HIGH description should contain 'Heavy'");

            assertTrue(AllocationMode.EXTREME.getDescription().contains("Extreme"),
                "EXTREME description should contain 'Extreme'");

            assertTrue(AllocationMode.OFF.getDescription().contains("No"),
        ...
        void descriptionsShouldContainRateInformation() {
            assertTrue(AllocationMode.LOW.getDescription().contains("1 MB/sec"),
                "LOW description should contain rate information");

            assertTrue(AllocationMode.MEDIUM.getDescription().contains("10 MB/sec"),
                "MEDIUM description should contain rate information");

            assertTrue(AllocationMode.HIGH.getDescription().contains("500 MB/sec"),
                "HIGH description should contain rate information");

            assertTrue(AllocationMode.EXTREME.getDescription().contains("2 GB/sec"),
    ...
    class EdgeCasesTests {
        ...
        void shouldHandleZeroAllocationsCorrectly() {
            assertEquals(0, AllocationMode.OFF.getAllocationsPerIteration(),
        ...
        void shouldHandleLargeAllocationsCorrectly() {
            ...
            assertTrue(extremeRate > 1_000_000_000L, // 1GB
                "EXTREME mode should handle large allocations (>1GB/sec)");

            assertEquals(2_048_000_000L, extremeRate,
                "EXTREME mode should handle exactly 2GB/sec");
        }
    ...
    class ConstantsValidationTests {
        ...
        void shouldValidateConstantValues() {
            ...
            for (AllocationMode mode : AllocationMode.values()) {
                ...
                assertEquals(expectedBytes, mode.getBytesPerAllocation(),
                    String.format("%s should use %d bytes per allocation", mode.name(), expectedBytes));
            }

            // Validate that calculation formula is consistent
            for (AllocationMode mode : AllocationMode.values()) {
                long expected = (long) mode.getAllocationsPerIteration() * mode.getBytesPerAllocation() * 10;
                assertEquals(expected, mode.getBytesPerSecond(),
