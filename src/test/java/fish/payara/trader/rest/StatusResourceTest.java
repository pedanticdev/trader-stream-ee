...
class StatusResourceTest {
  ...
  @Mock private AeronSubscriberBean subscriber;

  @Mock private MarketDataPublisher publisher;

  @Mock private MarketDataBroadcaster broadcaster;

  @InjectMocks private StatusResource statusResource;
  ...
  class GetStatusMethodTests {
    ...
    void shouldReturnCompleteStatusInformation() {
      ...
      try {
        ...
        assertEquals(
            "High-frequency trading dashboard with Aeron and SBE", status.get("description"));
  ...
  class GetClusterStatusMethodTests {
    ...
    void shouldReturnStandaloneStatusWhenHazelcastIsNull() {
      ...
      assertEquals(
          "Running in standalone mode (Hazelcast not available)", clusterInfo.get("message"));
    }
  }
  ...
  class EnvironmentVariableTests {
    ...
    void shouldHandleDifferentInstanceNameEnvironmentVariables() {
      String[] testNames = {
        "", "  ", "\tinstance-1", "instance-1", "test-instance-123", "production-instance"
      };
