...
public class GCTestUtil {
  ...
  public static GCStatistics calculateDelta(GCStatistics initial) {
    ...
    return new GCStatistics(
        totalCollections - initial.collections, totalTime - initial.time, getHeapUsage());
  }
  ...
  public static MemoryPressureThread createMemoryPressure(
      int allocationRateMB, int durationSeconds) {
    MemoryPressureThread pressureThread =
        new MemoryPressureThread(allocationRateMB, durationSeconds);
